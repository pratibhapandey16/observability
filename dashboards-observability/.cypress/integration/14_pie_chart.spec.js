...
const renderPieChart = () => {
  ...
  cy.get('.euiFlexItem.euiFlexItem--flexGrowZero .euiColorPickerSwatch.euiColorPicker__swatchSelect').eq(2).click({force: true});
...
describe('Renders Pie chart and Data Configurations section for Pie chart', () => {
  ...
  it('Collapsible mode for Data Configuration panel', () => {
    ...
    cy.get('.euiResizablePanel.euiResizablePanel--middle').contains('Data Configurations').should('not.be.focused');
  });
});
